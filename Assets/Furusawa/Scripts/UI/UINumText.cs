...
public class UINumText : MonoBehaviour
{
    ...
    private void CreateNum(int point)
    {
        ...
        GameObject obj = LoadGObject("Number", "NumTextGui");
        ...
        for (int i = 0; i < digit; i++)
        {
            ...
            //numObj.GetComponent<SpriteRenderer>().bounds.size = Vector3.one * size;
    ...
    void Update()
    {
        ...
        {
            Init(Random.Range(0, 9999), Vector3.zero);
        }
    }
